...
class AccountRepositoryTest {
    ...
    void shouldFindCorrectAccount_WhenMultipleAccountsExist() {
        ...
        assertThat(found.get().getBalance()).isEqualTo(new BigDecimal("5000"));
    }
    ...
    void shouldUpdateExistingAccount() {
        ...
        assertThat(found.getBalance()).isEqualTo(new BigDecimal("15000"));
    }
    ...
    void shouldPersistAllAccountFields() {
        ...
        assertThat(found.getBalance()).isEqualTo(new BigDecimal("10000"));
        assertThat(found.getDailyLimit()).isEqualTo(new BigDecimal("50000"));
        assertThat(found.getDailyUsed()).isEqualTo(new BigDecimal("5000"));
        assertThat(found.getMonthlyLimit()).isEqualTo(new BigDecimal("200000"));
        assertThat(found.getMonthlyUsed()).isEqualTo(new BigDecimal("20000"));
    ...
    void shouldHandleLargeBalanceValues() {
        ...
        Optional<Account> found = accountRepository.findByUpiId("alice@okaxis");
        assertThat(found).isPresent();
        assertThat(found.get().getBalance()).isEqualTo(new BigDecimal("9999999999.99"));
    }
